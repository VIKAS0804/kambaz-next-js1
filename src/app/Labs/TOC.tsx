...
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      <NavItem>
        <NavLink href="/Labs" as={Link} className={`nav-link ${pathname.endsWith("Labs") ? "active" : ""}`}>Home</NavLink>
      </NavItem>
      <NavItem>
      ...
      <NavItem>
        <NavLink href="https://github.com/VIKAS0804/" target="_blank">My GitHub</NavLink>
      </NavItem>
    </Nav>
  );
}